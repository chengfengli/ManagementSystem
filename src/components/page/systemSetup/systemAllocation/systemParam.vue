...
<style>
  ...
  .systemParam .systemParam-search div{display: inline-block;margin-right: 30px;}
  .systemParam .systemParam-search input{
    width: 120px;
    padding: 3px 0;
  }
  .systemParam .el-button{padding: 10px 3px;}
  .systemParam .systemParam-submit{padding: 6px 23px;box-sizing: border-box;}
